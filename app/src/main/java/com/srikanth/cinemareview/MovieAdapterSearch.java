...
public class MovieAdapterSearch extends RecyclerView.Adapter<MovieAdapterSearch.MovieViewHolder> {
    ...
    public MovieAdapterSearch(Context context, ArrayList<Details> movieList) {
        mContext = context;
