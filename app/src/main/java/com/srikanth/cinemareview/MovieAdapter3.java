...
public class MovieAdapter3 extends RecyclerView.Adapter<MovieAdapter3.MovieViewHolder3> {
    ...
    public interface OnItemClickListener3{
        void onItemClick3(int position3);
    ...
    public MovieAdapter3(Context context, ArrayList<Details> movieList) {
        mContext3 = context;
    ...
    public MovieViewHolder3 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext3).inflate(R.layout.horizontalview_layout, parent, false);
                ...
                public void onClick(View v) {
                    ...
                    if (mListener3!=null)
                    {
                        ...
                        if (position!=RecyclerView.NO_POSITION){
                            mListener3.onItemClick3(position);
                        }
                    }
