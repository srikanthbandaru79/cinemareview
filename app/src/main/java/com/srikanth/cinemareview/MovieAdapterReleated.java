...
public class MovieAdapterReleated extends RecyclerView.Adapter<MovieAdapterReleated.MovieViewHolder> {
    ...
    public MovieAdapterReleated(Context context, ArrayList<Details> movieList) {
        mContext = context;
