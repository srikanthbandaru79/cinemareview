...
public class TvDetailActivity extends AppCompatActivity implements MovieAdapterReleated.OnItemClickListener {
    ImageView mbackdrop;
    ...
    private void AparseJson1() {
        ...
        String url = "https://api.themoviedb.org/3/tv/" + id + "/similar?api_key=1069fb29d7ff035c5425b8c63b1512b8&language=en-US&page=1";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            mAdapter = new MovieAdapterReleated(TvDetailActivity.this, mMovieList1);
                            mRecyclerViewReleated.setAdapter(mAdapter);
                            mAdapter.setOnItemClickListener(TvDetailActivity.this);
    ...
    public void onItemClick(int position) {
        Intent detailIntent = new Intent(TvDetailActivity.this, TvDetailActivity.class);
